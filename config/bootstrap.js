...
module.exports.bootstrap = async function() {
  ...
  var HARD_CODED_DATA_VERSION = 0.44;
  ...
  await User.create({ 
    emailAddress: 'paul@beta-things.com', 
    fullName: 'Paul Myers', 
    isSuperAdmin: true, 
    password: await sails.helpers.passwords.hashPassword('abc123') 
  });

  var stockSalesAgent = await User.create({
    emailAddress: 'stan@tekskil.com', 
    fullName: 'Stan Markus', 
    isSuperAdmin: false, 
    password: await sails.helpers.passwords.hashPassword('abc123')
  }).fetch();

  var deletableSalesAgent = await User.create({
    emailAddress: 'forgettable@tekskil.com', 
    fullName: 'Worthless Pleb NPC', 
    isSuperAdmin: false, 
    password: await sails.helpers.passwords.hashPassword('abc123')
  }).fetch();
